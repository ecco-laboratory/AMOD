...
% get IAPS images
% read number of artificial stim based on runs into list
...
for f = num_run
    ...
    target_subject_full{f} = target_subject; %note to self: imgName stored in imgList under "name"
...
save(['enc_prediction_amySub_artStim.mat'],'enc_prediction');
